...
const items = [
  ...
  { id: 3, title: "PESQUISA", desc: "Nossa equipe foca em um aprendizado que vai além da aplicação de uma stack tecnológica. Ao aliar pesquisa e prática, promovemos um ambiente dinâmico, onde curiosidade e inovação são pilares essenciais do conhecimento", icon: teste }
];
